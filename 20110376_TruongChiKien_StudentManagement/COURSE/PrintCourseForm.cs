...
namespace _20110376_TruongChiKien_StudentManagement.COURSE
{
    public partial class PrintCoursesForm : Form
    {
        ...
        {
            DataGridView dgv = dataGridViewPrintCourse;
            ...
            for (int j = 0; j < rowCount; j++)
            {
                ...
                for (int i = 0; i < colCount; i++)
                {
                    ...
                    if (dgv.Columns[i] is DataGridViewImageColumn && cellValue != null)
                    {
                        ...
                        dataGridViewPrintCourse.Rows[j].Cells[10].Value = img;
        ...
        private void PrintCoursesForm_Load_1(object sender, EventArgs e)
        {
            COURSES course = new COURSES();
            dataGridViewPrintCourse.DataSource = course.getAllCourses();
            dataGridViewPrintCourse.Columns[0].HeaderText = " ID";
            dataGridViewPrintCourse.Columns[1].HeaderText = "Label";
            dataGridViewPrintCourse.Columns[2].HeaderText = "Period";
            dataGridViewPrintCourse.Columns[3].HeaderText = "Description";
            dataGridViewPrintCourse.Columns[4].HeaderText = "Semester";
            dataGridViewPrintCourse.Columns[5].HeaderText = "TeacherID";
        }
        ...
        private void buttonPrint_Click_1(object sender, EventArgs e)
        {
            if (dataGridViewPrintCourse.Rows.Count > 0)
            {
                try
                {
                    ...
                    {
                        exportDataToWord(dataGridViewPrintCourse, saveFileDialog1.FileName);
                    }
...
*/
        ...
        private void buttonSave_Click_1(object sender, EventArgs e)
        {
            ...
            using (var writer = new StreamWriter(path))
            {
                ...
                {
                    for (int j = 0; j < dataGridViewPrintCourse.Columns.Count; j++)
                    {
