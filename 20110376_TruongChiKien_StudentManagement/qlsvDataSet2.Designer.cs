...
namespace _20110376_TruongChiKien_StudentManagement {
    ...
    public partial class qlsvDataSet2 : global::System.Data.DataSet {
        ...
        public partial class std1DataTable : global::System.Data.TypedTableBase<std1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public std1Row Addstd1Row(int id, string fname, string lname, System.DateTime bdate, string gender, string phone, string email, string major, string hometown, string address, byte[] picture) {
...
namespace _20110376_TruongChiKien_StudentManagement.qlsvDataSet2TableAdapters {
    ...
    public partial class std1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[std1] ([id], [fname], [lname], [bdate], [gender], [phone], [email], [major], [hometown], [address], [picture]) VALUES (@id, @fname, @lname, @bdate, @gender, @phone, @email, @major, @hometown, @address, @picture);
SELECT id, fname, lname, bdate, gender, phone, email, major, hometown, address, picture FROM std1 WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[std1] SET [id] = @id, [fname] = @fname, [lname] = @lname, [bdate] = @bdate, [gender] = @gender, [phone] = @phone, [email] = @email, [major] = @major, [hometown] = @hometown, [address] = @address, [picture] = @picture WHERE (([id] = @Original_id) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_lname = 1 AND [lname] IS NULL) OR ([lname] = @Original_lname)) AND ((@IsNull_bdate = 1 AND [bdate] IS NULL) OR ([bdate] = @Original_bdate)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_major = 1 AND [major] IS NULL) OR ([major] = @Original_major)) AND ((@IsNull_hometown = 1 AND [hometown] IS NULL) OR ([hometown] = @Original_hometown)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)));
SELECT id, fname, lname, bdate, gender, phone, email, major, hometown, address, picture FROM std1 WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, fname, lname, bdate, gender, phone, email, major, hometown, address, p" +
                "icture FROM dbo.std1";
        ...
        public virtual int Fill(qlsvDataSet2.std1DataTable dataTable) {
        ...
        public virtual qlsvDataSet2.std1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            qlsvDataSet2.std1DataTable dataTable = new qlsvDataSet2.std1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(qlsvDataSet2.std1DataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_fname, string Original_lname, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_gender, string Original_phone, string Original_email, string Original_major, string Original_hometown, string Original_address) {
        ...
        public virtual int Insert(int id, string fname, string lname, global::System.Nullable<global::System.DateTime> bdate, string gender, string phone, string email, string major, string hometown, string address, byte[] picture) {
        ...
        public virtual int Update(
            ...
            if ((Original_bdate.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[17].Value = ((System.DateTime)(Original_bdate.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_hometown, 
                    string Original_address) {
            return this.Update(Original_id, fname, lname, bdate, gender, phone, email, major, hometown, address, picture, Original_id, Original_fname, Original_lname, Original_bdate, Original_gender, Original_phone, Original_email, Original_major, Original_hometown, Original_address);
        }
    }
